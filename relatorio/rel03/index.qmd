...
Para analisar a relação entre a idade dos corpos de prova e a resistência à compressão, foram calculadas as médias de resistência para cada idade. O valor de `280 dias` foi desconsiderado nesta análise por apresentar comportamento discrepante em relação às demais idades.
...
A relação entre idade e resistência média foi representada graficamente:
...
Após a retirada do valor discrepante, observa-se uma **tendência de aumento da resistência média com o avanço da idade**. Os resultados indicam, portanto, que os corpos de prova tendem a apresentar maior resistência à compressão nas idades mais avançadas, embora esse crescimento não ocorra necessariamente de forma uniforme.

Assim, os dados apresentam **evidência descritiva de uma relação positiva entre idade e resistência à compressão**.
